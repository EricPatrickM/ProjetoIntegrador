...
const ImagemAnimal = require('./models/ImagemAnimal');
const ImagemCliente = require('./models/ImagemCliente');
const ImagemLoja = require('./models/ImagemLoja');
    ...
    app.post('/RegistrarEnviar',function(req, res){
        ...
        try{
            ...
            Cliente.create({
                ...
                VisibilidadeCidade: req.body.Cidade,
                ...
                Disponivel: true,
            }).then(()=> res.redirect('/')).catch(function(){res.render('Registrar', {
                    Nome: req.body.Nome,
...
//LOGIN
    ...
    app.post('/LoginEnviar', function(req, res){
        res.render("LoginSucess", req.body);
    });
...
//CLIENTE screen and json
    app.get("/Cliente/:IdCliente",function(req, res){
        ...
        Cliente.findByPk(IdCliente).then((ResultadoConsulta)=>{
            /*console.log("CHAVES: " + Object.keys(e));
    ...
    app.get("/Animal/:AnimalId",function(req, res){
        const AnimalId = parseInt(req.params.AnimalId);
            Animal.findByPk(AnimalId).then((ResultadoConsulta)=>{
                /*console.log("CHAVES: " + Object.keys(ResultadoConsulta));
                console.log("TIPO: " + typeof(e));*/
                if(req.query.device=="Mobile"){
...
//PRODUTO
    app.get("/Loja/:StoreId/:ProdutoId",function(req, res){
